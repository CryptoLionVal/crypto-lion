                ...
                <div className={styles.container}>
                    <div className={styles.content}>
                        <Image
                            ...
                            alt="Crypto Lion"
                        />
                        <h3 className={styles.slugText}></h3>
                        <h3 className={styles.slugText} ref={el}></h3>
                    </div>
                    ...
                    <div className={styles.footer}>
                            ...
                            <SwiperSlide tag="li">
                                <a href="https://wallet.keplr.app/chains/gravity-bridge?modal=validator&chain=gravity-bridge-3&validator_address=gravityvaloper16lhapna7nfm0j3pnwt7tn4lxtx3q7hs4qx9fgg"
                                   ...
                                   title="Gravity Bridge Valdator Crypto Lion">
                                    ...
                                    <span></span>
                                    <span></span>
                                    <span><Image src={gravityLogo} height={50} width={50} alt="Gravity Bridge"/></span>
                                </a>
                            </SwiperSlide>
                            <SwiperSlide tag="li">
                        ...
                        <p>
                            <a href="https://twitter.com/CryptoLionVal" title="Crypto Lion Twitter">
                                <Image src={twitterLogo} height={16} width={16} alt="Crypto Lion Twitter"/> Twitter
                            </a>
                            <a href="https://discord.gg/UJBwXnAc" title="Crypto Lion Discord">
                                <Image src={discordLogo} height={16} width={16} alt="Crypto Lion Discord"/> Discord
                            </a>
                            <a href="mailto:contact@cryptolion.finance" title="Crypto Lion Contact">
                                <Image src={emailLogo} height={16} width={16} alt="Crypto Lion Contact"/> Email
                            </a>
                            <a href="https://github.com/CryptoLionVal" title="Crypto Lion GitHub">
                                <Image src={githubLogo} height={16} width={16} alt="Crypto Lion GitHub"/> GitHub
                            </a>
                        </p>
                    </div>
                </div>
